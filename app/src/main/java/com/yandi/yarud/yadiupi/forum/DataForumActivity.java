...
public class DataForumActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void tampilanToolbar() {
        ...
        toolbar.setSubtitle("Forum Diskusi");
    ...
    public void RunningPage(String token) {
        new UrlUpi();
        ApiAuthenticationClientJWT apiAuthenticationClientJWT = new ApiAuthenticationClientJWT(UrlUpi.URL_DataForum+"18100032781581GD541K06520181",token);
