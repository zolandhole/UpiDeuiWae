...
import com.yandi.yarud.yadiupi.adapter.AdapterPemilihanKM;
...
public class PemilihanKMActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        namakelas = Objects.requireNonNull(getIntent().getExtras()).getString("NAMAKELAS");
        initView();
        initListener();
        tampilanToolbar();
        initRunning();
    ...
    private void initListener(){
        ...
        AdapterPemilihanKM mAdapter = new AdapterPemilihanKM(this, item);
