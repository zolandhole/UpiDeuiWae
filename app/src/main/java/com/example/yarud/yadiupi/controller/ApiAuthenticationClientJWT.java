...
public class ApiAuthenticationClientJWT {
     ...
     * @param token String
     */
    public ApiAuthenticationClientJWT(String  baseUrl, String token) {
        setBaseUrl(baseUrl);
        this.token = token;
        this.urlResource = "";
        this.urlPath = "";
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT setBaseUrl(String baseUrl) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT setUrlResource(String urlResource) {
     ...
     * @return this
     */
    public final ApiAuthenticationClientJWT setUrlPath(String urlPath) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT setHttpMethod(String httpMethod) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT setParameters(HashMap<String, String> parameters) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT setParameter(String key, String value) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT clearParameters() {
     ...
     */
    public ApiAuthenticationClientJWT removeParameter(String key) {
     ...
     * @return this
     */
    public ApiAuthenticationClientJWT clearAll() {
        parameters.clear();
        baseUrl = "";
        this.token = "";
        this.urlResource = "";
